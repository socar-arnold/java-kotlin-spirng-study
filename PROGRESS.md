...
## 현재 위치
- **Stage:** 1 (Kotlin 기초) — Phase 1-B (OOP) 진행 중
- **진행:** 누적 **6세션 완료** (Stage 0: 2 / Stage 1: 4 — 1A①,1A②,1B-sealed 등). 세션 = 약 45~90분 학습 단위 ([LEARNING_TRACK.md](LEARNING_TRACK.md) 보정 기준)
- **Stage 1 잔여:** ~11세션 (1-B 마무리 + 1-C 제네릭/1-D 컬렉션/1-E FP/1-F 예외 + 미션 3개)
- **다음:** 인터페이스/추상클래스/다형성 → 숫자야구 미션
- **실측 페이스:** 5/22 4세션 + 5/25 1세션~ → 개념은 계획比 ~3배 빠름, 미션이 시간 변수
